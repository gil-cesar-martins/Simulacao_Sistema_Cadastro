...
namespace Sistema_Cadastro
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            comboEC.Items.Add("União Estável");

            comboEC.SelectedIndex = 1;  // Já inicia com o índice 1 selecionado, no caso corresponde a Solteiro(a)
        }
        ...
        private void BtnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            if (txtTelefone.Text == "(  )      -")
            {
                MessageBox.Show("Preencher campo 'Telefone'.");
                txtTelefone.Focus();
                return;
            }
